...
class Wallet(models.Model):
    address = models.CharField(max_length=42, unique=True, validators=[RegexValidator(regex='^(tb1|[2nm]|bcrt)[a-zA-HJ-NP-Z0-9]{25,42}$')])
...
class Payment(models.Model):
    ...
    invoice = models.CharField(max_length=500, null=True, validators=[RegexValidator(regex='^lntb(\d{1,12})(\w{200,550})$')])
    description = models.CharField(max_length=120,blank=True,null=True)
    value = models.IntegerField(validators=[MinValueValidator(100),MaxValueValidator(100000000)]) # Satoshis
