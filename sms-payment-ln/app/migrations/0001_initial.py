# Generated by Django 3.1.4 on 2020-12-27 00:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.CharField(blank=True, max_length=42, null=True, validators=[django.core.validators.RegexValidator(regex='^(tb1|[2nm]|bcrt)[a-zA-HJ-NP-Z0-9]{25,42}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('invoice', models.CharField(max_length=500, validators=[django.core.validators.RegexValidator(regex='^lntb(\\d{1,12})(\\w{200,550})$')])),
